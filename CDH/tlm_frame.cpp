...
int TLM_OBC_01(void) {
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 22] = (unsigned char)((*((unsigned char*)&(tl_cmd_list.pl_public.executed_nodes))) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 23] = (unsigned char)((*((unsigned char*)&(tl_cmd_list.pl_public.active_nodes))) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 24] = (unsigned char)((unsigned char)fram_tlc_exec_count & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 25] = (unsigned char)((unsigned char)fram_tlc_queue & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 26] = (unsigned char)((*((unsigned char*)&(bcti->pos.block))) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 27] = (unsigned char)((*((unsigned char*)&(bcti->pos.cmd))) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 28] = (unsigned char)((unsigned char)Stored_BC_Number & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 29] = (unsigned char)((unsigned char)Stored_BC_Position & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 30] = (unsigned char)(pwr_sts.msn_unreg & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 31] = (unsigned char)(pwr_sts.heater & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 32] = (unsigned char)(pwr_sts.rw & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 33] = (unsigned char)(pwr_sts.adcs & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 34] = (unsigned char)(pwr_sts.msn5v & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 35] = (unsigned char)(pwr_sts.subcam & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 36] = (unsigned char)(pwr_sts.sf & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 37] = (unsigned char)(pwr_sts.msn_unreg_en & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 38] = (unsigned char)(pwr_sts.rw_en & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 39] = (unsigned char)(pwr_sts.aqu_5v & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 40] = (unsigned char)(pwr_sts.ovco & 0xFF);  //	
	p = (unsigned char*)&(eps_bat_v)+3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 41 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 41 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 41 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 41 + 3] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 45] = (unsigned char)(pdu_analog_tlm.rw_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 46] = (unsigned char)(pdu_analog_tlm.rw_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 47] = (unsigned char)(pdu_analog_tlm.adcs_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 48] = (unsigned char)(pdu_analog_tlm.adcs_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 49] = (unsigned char)(pdu_analog_tlm.msn5v_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 50] = (unsigned char)(pdu_analog_tlm.msn5v_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 51] = (unsigned char)(pdu_analog_tlm.subcam_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 52] = (unsigned char)(pdu_analog_tlm.subcam_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 53] = (unsigned char)(pdu_analog_tlm.sf_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 54] = (unsigned char)(pdu_analog_tlm.sf_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 55] = (unsigned char)(pdu_analog_tlm.msn_unreg_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 56] = (unsigned char)(pdu_analog_tlm.msn_unreg_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 57] = (unsigned char)(pdu_analog_tlm.strx_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 58] = (unsigned char)(pdu_analog_tlm.strx_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 59] = (unsigned char)(pdu_analog_tlm.heater_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 60] = (unsigned char)(pdu_analog_tlm.heater_voltage.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 61] = (unsigned char)(pcu_analog_tlm.sap1_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 62] = (unsigned char)(pcu_analog_tlm.sap2_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 63] = (unsigned char)(pcu_analog_tlm.sap3_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 64] = (unsigned char)(pcu_analog_tlm.sap4_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 65] = (unsigned char)(pcu_analog_tlm.sap_v1.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 66] = (unsigned char)(pcu_analog_tlm.sap_v2.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 67] = (unsigned char)(pcu_analog_tlm.batt1_v.byte_value & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 72] = (unsigned char)(pcu_analog_tlm.dcdc1_current.byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 73] = (unsigned char)(uvci.is_enabled & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 74] = (unsigned char)(uvci.level & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 75] = (unsigned char)(uvci.threshold[0] & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 76] = (unsigned char)(uvci.threshold[1] & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 77] = (unsigned char)(uvci.threshold[2] & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 78] = (unsigned char)(pcu_select & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 79] = (unsigned char)(temp_sens.an_tlm[0].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 80] = (unsigned char)(temp_sens.an_tlm[1].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 81] = (unsigned char)(temp_sens.an_tlm[2].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 82] = (unsigned char)(temp_sens.an_tlm[3].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 83] = (unsigned char)(temp_sens.an_tlm[4].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 84] = (unsigned char)(temp_sens.an_tlm[5].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 85] = (unsigned char)(temp_sens.an_tlm[6].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 86] = (unsigned char)(temp_sens.an_tlm[7].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 87] = (unsigned char)(temp_sens.an_tlm[8].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 88] = (unsigned char)(temp_sens.an_tlm[12].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 89] = (unsigned char)(temp_sens.an_tlm[13].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 90] = (unsigned char)(temp_sens.an_tlm[14].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 91] = (unsigned char)(temp_sens.an_tlm[15].byte_value & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 92] = (unsigned char)(mtq_sts.x & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 93] = (unsigned char)(mtq_sts.y & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 94] = (unsigned char)(mtq_sts.z & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 95] = (unsigned char)(hk_dr.enabled & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 98 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 98 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 100] = (unsigned char)(hk_dr.replay_enabled & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 111] = (unsigned char)(msn_dr.enabled & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 114 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 114 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 116] = (unsigned char)(msn_dr.replay_enabled & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 119 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 119 + 1] = (unsigned char)(*p);	p--;
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 123] = (unsigned char)(strx_sts.spc_counter & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 124] = (unsigned char)(strx_sts.wdt_counter & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 127 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 127 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 127 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 127 + 3] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 131] = (unsigned char)(strx_sts.tx_power & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 134] = (unsigned char)(strx_sts.volt & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 135] = (unsigned char)(strx_sts.carrier_lock & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 136] = (unsigned char)(strx_sts.sub_carrier_lock & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 137] = (unsigned char)(strx_sts.bitrate & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 138] = (unsigned char)(strx_sts.pwr_level & 0xFF);  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 149] = (unsigned char)(ahi->respond_at.master & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 150] = (unsigned char)((((unsigned char*)&(ahi->respond_at.step))[0]) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 151] = (unsigned char)((((unsigned char*)&(ahi->latest_id))[0]) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 152] = (unsigned char)((((unsigned char*)&(ahi->elements[0].is_active))[0]) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 153] = (unsigned char)((((unsigned char*)&(ahi->elements[1].is_active))[0]) & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 154] = (unsigned char)((((unsigned char*)&(ahi->elements[2].is_active))[0]) & 0xFF);  //	
...
int TLM_OBC_50(void) {
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 0] = (unsigned char)(aqu_info.is_enabled & 0xFF);  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 1] = (unsigned char)(aqu_info.sts & 0xFF);  //	
	p = (unsigned char*)&(aqu_info.anm_thr_diff_ps) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 2 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 2 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 2 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 2 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.anm_thr_time_rv_open) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 6 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 6 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.anm_thr_time_tv_open) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 8 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 8 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.anm_thr_temperature) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 10 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 10 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 10 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 10 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_DIF_PRESSURE_TPS_01) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 14 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 14 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_DIF_PRESSURE_TPS_02) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 18 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 18 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_RTS1) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 22 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 22 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 22 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 22 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_RTS2) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 26 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 26 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_RTS3) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 30 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 30 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_RTS4) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 34 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 34 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 34 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 34 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS1) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 38 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 38 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS2) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 42 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 42 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS3) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 46 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 46 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 46 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 46 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS4) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 50 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 50 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS5) + 3;  //	
	...
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 54 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 54 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_VTS6) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 58 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 58 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 58 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 58 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_WTS) + 3;  //	
	...
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_TTS) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 66 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 66 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 66 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 66 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_TEMPERATURE_DTS) + 3;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 70 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 70 + 1] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 70 + 2] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 70 + 3] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RV1) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 74 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 74 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RV2) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 76 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 76 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RV3) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 78 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 78 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RV4) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 80 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 80 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_VDV) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 82 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 82 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_DTV1) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 84 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 84 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_DTV2) + 1;  //	
	...
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_DTV3) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 88 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 88 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_DTV4) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 90 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 90 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RTV1) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 92 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 92 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RTV2) + 1;  //	
	...
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RTV3) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 96 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 96 + 1] = (unsigned char)(*p);	p--;
	p = (unsigned char*)&(aqu_info.tlm.AQU_VALVE_OPEN_TIME_RTV4) + 1;  //	
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 98 + 0] = (unsigned char)(*p);	p--;
	TlmTransferFrame.Packet.packet_data[TLM_POSITION_MAIN + 98 + 1] = (unsigned char)(*p);	p--;
	return(100);
}
